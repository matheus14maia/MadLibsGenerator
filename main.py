...
# Create a Display Window and initialize
root = Tk()
...
def madlib1():
    ...
    if profession[0:1] == 'a'or'e'or'i'or'o'or'u':
        a = 'an'
    else:
        a = 'a'
    ...
    f' pretending to be {a} ' + profession + '. when we saw the second photo, it was exactly what I wanted. '
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' + adjactive + ' butterfly with ' + color +
    ...
    ' when we got there and then decided to ' + verb + ' and the dream ended when I said-- lets ' +
    verb + '.')
...
def madlib3():
    ...
    color + ' apples straight off the tree that tested like ' + foods + '. Then there was a ' +
